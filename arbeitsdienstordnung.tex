...
\subsection{§ 2 Zweck der Arbeitsdienste}
\begin{enumerate}
...
\subsection{§ 5 Erscheinen und Abmeldung}
\begin{enumerate}
...
\subsection{§ 6 Dokumentation der Arbeitsstunden}
\begin{enumerate}
