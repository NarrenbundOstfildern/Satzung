...
\subsection{§ \theparagraphcounter\ Erlass, Änderung, Aufhebung und Bekanntmachung} \label{go:par:erlass_aenderung_aufhebung}
\begin{enumerate}
    \item \label{go:abs:kwyvk7} Diese Geschäftsordnung kann jederzeit durch den Vereinsausschuss erarbeitet werden.

    \item \label{go:abs:1rro4u} Erlass, Änderungen oder Aufhebung der Geschäftsordnung bedürfen der Genehmigung durch die Mitgliederversammlung gemäß § 14 Abs. 2 der Satzung.
...
\subsection{§ \theparagraphcounter\ Interne Aufgaben- und Zuständigkeitsverteilung} \label{go:par:intern_aufgaben_zustaendigkeit}
...
\refstepcounter{paragraphcounter}
\subsection{§ \theparagraphcounter\ Wahlturnus} \label{go:par:wahlturnus}
\begin{enumerate}
    ...
    \item \label{go:abs:nvhuj8} Wird ein Mitglied des Vorstands gemäß § 8 Abs. 9 der Satzung neu gewählt, gilt dies nur für die verbleibende Amtszeit des ausgeschiedenen Vorstandsmitglieds, sodass der bestehende Wahlturnus des Vereins unberührt bleibt. \\
...
\refstepcounter{paragraphcounter}
\subsection{§ \theparagraphcounter\ Ausschüsse} \label{go:par:ausschuesse}
\begin{enumerate}
...
\refstepcounter{paragraphcounter}
\subsection{§ \theparagraphcounter\ Mitgliedschaft} \label{go:par:mitgliedschaft}
\begin{enumerate}
    ...
    \item \label{go:abs:uvjuiz} Nach erfolgreichem Abschluss des Probejahres entscheidet der Ausschuss über die endgültige Aufnahme als Mitglied gemäß § 4 Abs. 6 der Satzung. Erst nach der endgültigen Aufnahme als Mitglied ist die Anfertigung des jeweiligen Häs zulässig.
...
\refstepcounter{paragraphcounter}
\subsection{§ \theparagraphcounter\ Stellung der einzelnen Maskengruppen und Abteilungen} \label{go:par:maskengruppen_abteilungen}
\begin{enumerate}
...
\refstepcounter{paragraphcounter}
\subsection{§ \theparagraphcounter\ Gruppenwechsel innerhalb des NBO} \label{go:par:gruppenwechsel}
\begin{enumerate}
...
\refstepcounter{paragraphcounter}
\subsection{§ \theparagraphcounter\ Sprunggeld} \label{go:par:sprunggeld}
\begin{enumerate}
...
\refstepcounter{paragraphcounter}
\subsection{§ \theparagraphcounter\ Spenden} \label{go:par:spenden}
\begin{enumerate}
    \item \label{go:abs:fs63cc} Etwaige Spenden fließen dem Narrenbund Ostfildern e.V. auf einem gesonderten Konto zu. Diese veranlasst die Ausstellung der entsprechenden Spendenbescheinigungen bzw. –quittungen, innerhalb des zugeflossenen Kalenderjahres.
\end{enumerate}

\refstepcounter{paragraphcounter}
\subsection{§ \theparagraphcounter\ Verhaltensregeln} \label{go:par:verhaltensregeln}
\begin{enumerate}
    ...
    \item \label{go:abs:egp5vc} Das Ausleihen, sowie der Tausch der Maske bzw. des Häs sind nicht gestattet.
...
\refstepcounter{paragraphcounter}
\subsection{§ \theparagraphcounter\ Schlussbestimmungen} \label{go:par:schlussbestimmungen}
...
\refstepcounter{paragraphcounter}
\subsection{§ \theparagraphcounter\ Inkrafttreten} \label{go:par:inkrafttreten}
\begin{enumerate}
