...
\subsection{§ \theparagraphcounter\ Erlass, Änderung, Aufhebung und Bekanntmachung} \label{jo:par:erlass_aenderung_aufhebung}
\begin{enumerate}
...
\subsection{§ \theparagraphcounter\ Zugehörigkeit zur Jugend} \label{jo:par:zugehoerigkeit_jugend}
\begin{enumerate}
...
\refstepcounter{paragraphcounter}
\subsection{§ \theparagraphcounter\ Jugendleitung} \label{jo:par:jugendleitung}
\begin{enumerate}
...
\refstepcounter{paragraphcounter}
\subsection{§ \theparagraphcounter\ Rechte der Jugendleitung im Verein} \label{jo:par:rechte_jugendleitung}
\begin{enumerate}
    \item \label{jo:abs:oso8pe} Der Jugendleiter hat gemäß § 9 Abs. 1 der Satzung Sitz und Stimme im Ausschuss des Vereins.
...
\refstepcounter{paragraphcounter}
\subsection{§ \theparagraphcounter\ Haftung und Verantwortung} \label{jo:par:haftung_verantwortung}
\begin{enumerate}
    \item \label{jo:abs:gh3w5l} Die Jugendleitung haften gegenüber dem Verein und seinen Mitgliedern nur für vorsätzliche oder grob fahrlässige Schäden, im Rahmen der gesetzlichen Ehrenamtshaftung.
...
\refstepcounter{paragraphcounter}
\subsection{§ \theparagraphcounter\ Inkrafttreten} \label{jo:par:inkrafttreten}
\begin{enumerate}
