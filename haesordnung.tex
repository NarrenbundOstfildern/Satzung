...
\subsubsection{§ \theparagraphcounter\ Erlass, Änderung, Aufhebung und Bekanntmachung}
\begin{enumerate}
...
\subsubsection{§ \theparagraphcounter\ Auftreten}
\begin{enumerate}
...
\refstepcounter{paragraphcounter}
\subsubsection{§ \theparagraphcounter\ Häskontrolle}
\begin{enumerate}
...
\refstepcounter{paragraphcounter}
\subsubsection{§ \theparagraphcounter\ Zeitwertermittlung beim Austritt}
\begin{enumerate}
...
\subsubsection{§ \theparagraphcounter\ Häsbestandteile}
\begin{enumerate}
...
\refstepcounter{paragraphcounter}
\subsubsection{§ \theparagraphcounter\ Ergänzungsbestandteile}
\begin{enumerate}
...
\refstepcounter{paragraphcounter}
\subsubsection{§ \theparagraphcounter\ Besondere Regelungen}
...
\subsubsection{§ \theparagraphcounter\ Inkrafttreten}
\begin{enumerate}
