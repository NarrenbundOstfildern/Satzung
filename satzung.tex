...
\subsection{§ 1 Name, Sitz und Geschäftsjahr}
...
\begin{enumerate}
    ...
    \item Der Verein kann weiteren Abteilungen einen eigenen Gruppennamen geben, der aber vom Vereinsausschuss genehmigt wird; Neue Abteilungen haben keine eigene Rechtspersönlichkeit.
\end{enumerate}

\subsection{§ 2 Zweck des Vereins}
...
\begin{enumerate}
    ...
    \\
    Der Vereinszweck wird vorallem durch folgende Aktivitäten verwirklicht:
    \begin{itemize}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item außerordentliche Mitglieder (z.B. passive Mitglieder)
        \item Ehrenmitglieder
    \end{enumerate}
\end{enumerate}

\subsection{§ 4 Erwerb und Erlöschen der Mitgliedschaft}
\begin{enumerate}
    ...
    \item Die Mitgliedschaft wird durch Eintritt in den Verein erlangt. Über die Aufnahme neuer Mitglieder entscheidet nach Abschluss des Probejahres der Vereinsausschuss. Die Mitgliederversammlung kann eine Empfehlung aussprechen.
...
\subsection{§ 6 Rechte und Pflichten der Mitglieder}
\begin{enumerate}
    ...
    \item Ordentliche, außerordentliche und Ehrenmitglieder, die das 18. Lebensjahr vollendet haben, sind berechtigt, an der Willensbildung im Verein durch Ausübung des Antrags-, Diskussions- und Stimmrechts in der Mitgliederversammlung teilzunehmen.
...
\subsection{§ 7 Organe des Vereins}
\begin{enumerate}
...
\begin{enumerate}
    ...
    \item Der 1. Vorstand und 1. stellv. Vorstand sind jeweils Einzelvertretungsberechtigt.

    \item Der 2. stellv. Vorstand vertritt den Verein gemeinsam mit einem weiteren Mitglied des Vorstands.
    ...
    \item Wählbar sind nur voll aufgenommene Mitglieder aus den jeweiligen Gruppen, keine Probeläufer. Die doppelte Belegung von Ämtern durch eine Person innerhalb des Vorstandes ist nicht zulässig. 
...
\subsection{§ 9 Der Vereinsausschuss}
\begin{enumerate}
    ...
    \item Die Beschlüsse werden mit einfacher Mehrheit gefasst. Bei Stimmengleichheit entscheidet die Stimme des 1. Vorstands bzw. bei Abwesenheit die des jeweiligen Vertreters.
    ...
    \item Wählbar sind nur voll aufgenommene Mitglieder aus den jeweiligen Gruppen, keine Probeläufer.
...
\subsection{§ 10 Die Mitgliederversammlung}
\begin{enumerate}
    ...
    \item Die Einberufung der Mitgliederversammlung erfolgt mindestens zwei Wochen vorher per E-Mail an die Mitglieder. Zusätzlich kann die Einberufung im Amtsblatt der Stadt Ostfildern veröffentlicht und auf der Internetseite des Vereins eingestellt werden. Maßgeblich für die Wahrung der Frist ist ausschließlich die Versendung der E-Mail.
    ...
    \item Die Tagesordnung ist zu ergänzen, wenn ein dies Mitglied bis spätestens eine Woche vor dem angesetzten Termin schriftlich fordert. Die Ergänzung ist zu Beginn der Versammlung bekannt zu machen.
...
\subsection{§ 11 Außerordentliche Mitgliederversammlung}
\begin{enumerate}
    \item Eine außerordentliche Mitgliederversammlung findet statt, wenn mindestens ein viertel aller Mitglieder sie unter Angabe von Gründen verlangen.
...
\subsection{§ 13 Auflösung des Vereins}
\begin{enumerate}
...
\subsection{§ 15 Die Gruppen innerhalb der Zunft}
\begin{enumerate}
    \item Dem Narrenbund Ostfildern e.V. gehören folgende Gruppen an:
    \begin{itemize}
        \item Rotbartle
        \item Kropfschell
...
\subsection{§ 16 Narrenbekleidung}
\begin{enumerate}
    \item Für jede Maskengruppe besteht eine Häsordnung, die Aussehen, Bestandteile und Trageweise des jeweiligen Häses regelt.

    \item Die Häsordnungen sind für alle Mitglieder der jeweiligen Gruppe verbindlich.

    \item Erlass, Änderungen und Aufhebung der Häsordnungen erfolgen nach Maßgabe von § 14 Ordnungen.

    \item Jedes Mitglied des Narrenbund Ostfildern e.V. hat sein Häs käuflich zu erwerben und es geht in seinen Besitz über.

    \item Beim Austritt aus dem Verein kann der Verein das Häs zum Zeitwert zurückkaufen. Die Berechnung des Zeitwerts erfolgt nach den Grundsätzen, die in der Häsordnung festgelegt werden.

    \item Jedes ausgetretene Mitglied kann sein Häs auch behalten; es darf in der Öffentlichkeit jedoch nicht mehr getragen werden.

    \item Das Häs ist in seiner Art und Darstellung Eigentum des Vereins und darf nur im Rahmen von Vereinsveranstaltungen oder vom Verein genehmigten Teilnahmen an Veranstaltungen der schwäbisch-alemannischen Fasnet getragen werden. Eine Nutzung des Häses außerhalb dieses Rahmens bedarf der ausdrücklichen Zustimmung des Vorstands.

    \item Verstößt ein ehemaliges Mitglied dagegen, so können von dem Verein Unterlassungsansprüche geltend gemacht werden.

    \item  Jedes Mitglied ist verpflichtet, eine durch den Verein zugewiesene Nummer deutlich sichtbar am linken Oberarm seines Häs anzubringen, um die zum Schadenersatz verpflichtende Handlungen nach Verursacherprinzip festzustellen.

    \item Bei mutwilliger Zerstörung des Leihhäs, oder der vom Verein gestellten Vereinskleidung wird der Betrag zur Neuanschaffung erhoben.
\end{enumerate}

\subsection{§ 17 Inkrafttreten}
\begin{enumerate}
